...
const dailymotionConfig = {
  ...
  languages: {
    en: {
      notice:
        'This content is hosted by a third party. By showing the external content you accept the <a rel="noreferrer noopener" href="https://www.dailymotion.com/legal/privacy?localization=en" target="_blank">terms and conditions</a> of dailymotion.com.',
      loadBtn: "Load video",
      loadAllBtn: "Don't ask again",
    },
  },
...
const twitchConfig = {
  ...
  languages: {
    en: {
      notice:
        'This content is hosted by a third party. By showing the external content you accept the <a rel="noreferrer noopener" href="https://www.twitch.tv/p/en/legal/terms-of-service/" target="_blank">terms and conditions</a> of twitch.com.',
      loadBtn: "Load stream",
      loadAllBtn: "Don't ask again",
    },
  },
...
const GoogleMapsAPIConfig = {
  ...
  languages: {
    en: {
      notice:
        'This content is hosted by a third party. By showing the external content you accept the <a rel="noreferrer noopener" href="https://cloud.google.com/maps-platform/terms" target="_blank">terms and conditions</a> of Google Maps.',
      loadBtn: "Load map",
      loadAllBtn: "Don't ask again",
    },
  },
